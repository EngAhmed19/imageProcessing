import numpy as np
from helperFunctions import custImageToGray, convolution, custGenericFilter # NOQA
...
=======
	...
	def homogeneityOperator(self, area_size: int = 3, threshold: int = None) -> np.ndarray:
		...
		Returns:
			np.ndarray: The threshold edge map.
		...
		# Convert to 0 or 255 (binary image)
		edge_map = (filtered_image > threshold).astype(np.uint8) * 255
		# print(f"Filter image in the class  {filtered_image.shape}")
		# print(f"Edge map in the class  {edge_map.shape}")
		return edge_map
	...
	def contrastBaseEdgeDetector(self):
		pass

	def varianceEdgeDetector(self):
		pass
>>>>>>> 1b47a0b1ad35d13eb5b776fc596a86440cfe1786
